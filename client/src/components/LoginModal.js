...
function LoginModal(props) {
    ...
    function handleSubmit(event) {
        ...
        checkAuthUser(user)
            ...
            .catch(err => alert("Credenciais não encontradas na base de dados. Tente novamente por favor."));
    ...
    return (
        <>
            <button className="btn header-button" style={{backgroundColor: "#ff6363", color: "white"}} onClick={handleShow}>
                Log-in
            </button>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body style={{ backgroundColor: "#39AEC5", borderBottomLeftRadius: "5px", borderBottomRightRadius: "5px"}}>
                    ...
                    <button className="btn btn-light header-button" style={{margin: "0 auto", backgroundColor: "#ff6363", color: "white"}} onClick={handleSubmit}>
                        Log-in
                    </button>
